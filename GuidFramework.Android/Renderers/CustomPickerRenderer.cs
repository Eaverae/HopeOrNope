	...
	public class CustomPickerRenderer : PickerRenderer, IOnClickListener
	{
		...
		public void OnClick(global::Android.Views.View view)
		{
			...
			if (model.Items != null && model.Items.Any())
			{
				...
				picker.DescendantFocusability = global::Android.Views.DescendantFocusability.BlockDescendants;
				picker.Value = model.SelectedIndex;
			}

			LinearLayout layout = new LinearLayout(Context) { Orientation = global::Android.Widget.Orientation.Vertical };
