...
namespace GuidFramework.ViewModels
{
	...
	public class FullscreenAdPopupViewModel : BaseViewModel
	{
		...
		public FullscreenAdPopupViewModel(string adId, string loadingText = "Loading", string continueText = "Continue", string secondaryAdId = null)
		{
